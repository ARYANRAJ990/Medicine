                              ...
                              children: <TextSpan>[
                                ...
                                TextSpan(
                                  ...
                                  style: TextStyle(
                                    ...
                                    fontSize: 16,
                                    color: Color(
                                        0xFFffb84d), // Color for 'Invitle Link'
                                  ),
                                ),
                              ],
                            ),
              ...
              child: Center(
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      // Constants.prefs.setBool(AppStrings.isLoggedIn, false);
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      shape: RoundedRectangleBorder(
                        ...
                        side: BorderSide(
                            color: Color(0xFF665CF5),
                            width: 2), // Outer line in blue color
                      ),
                    ),
                    child: Text(
                      'Logout',
                      style: TextStyle(
                        color: Colors
                            .black, // Text color to match the border, if desired
                        fontSize: 18,
    ...
    child: Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            mainAxisAlignment:
                MainAxisAlignment.spaceEvenly, // To space out the icons
            children: [
              Column(
                children: [
                  IconButton(
